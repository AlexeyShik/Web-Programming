...
public class FrontServlet extends HttpServlet {
    ...
    private boolean processMethod(HttpServletRequest request, HttpServletResponse response, Map<String, Object> view,
                               Class<?> pageClass, Object page, Method method) throws IOException, ServletException {
        try {
    ...
    private void process(Route route,
        ...
        processMethod(request, response, view, pageClass, page, findMethod(pageClass, "before"));
        boolean needTemplate = processMethod(request, response, view, pageClass, page, actionMethod);
        processMethod(request, response, view, pageClass, page, findMethod(pageClass, "after"));
